      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className='tetx-md text-gray-500 flex flex-col gap-6'>
            <p>Welcome to Etim's Blog! This blog was created by Etim David as a personal project for the community to share his thoughts and ideas with the world. Etim is a passionate developer and trader who loves to write about technology, trade, and everything in between.
            </p>
